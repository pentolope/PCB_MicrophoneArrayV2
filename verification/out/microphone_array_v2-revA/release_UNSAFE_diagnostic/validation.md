...
- Manifest: `manifest.json` sha256 `4bb5d604199db357`
- Constraint version: `revA-frozen-2026-08-01`
- KiCad: `unrecorded`
- Generated: 2026-08-05T07:20:03.067760+00:00
...
| `CFG.THRESHOLD_PARITY` | PASS | all 42 applied limits are typed constraints traced to the manifest |
...
Limits applied:
- `assembly.required_part_fields` = ['LCSC'] field name [policy] (from manifest.json#assembly.required_part_fields@4bb5d604199d)
- `assembly.compared_part_fields` = ['LCSC', 'MPN', 'Manufacturer'] field name [policy] (from manifest.json#assembly.compared_part_fields@4bb5d604199d)
...
Limits applied:
- `geometry.waiver_location_mm` = 0.001 mm [tolerance] (from manifest.json#geometry_profile.tolerances.waiver_location_mm.value@4bb5d604199d)
...
Limits applied:
- `checks.drc.forbidden_severities` = ['ignore'] severity [policy] (from manifest.json#checks.drc.forbidden_severities@4bb5d604199d)
...
Limits applied:
- `geometry.polygon_chord_error_mm` = 0.001 mm [tolerance] (from manifest.json#geometry_profile.tolerances.polygon_chord_error_mm.value@4bb5d604199d)
- `net_topology.PDM_CLOCK_BRANCHES.max_spread_mm` = 5.0 mm [policy] (from manifest.json#net_topology.rules.0.max_spread_mm@4bb5d604199d)
- `net_topology.PDM_CLOCK_BRANCHES.max_vias_per_net` = 0 vias [policy] (from manifest.json#net_topology.rules.0.max_vias_per_net@4bb5d604199d)
- `net_topology.PDM_CLOCK_ROOT.max_vias_per_net` = 0 vias [policy] (from manifest.json#net_topology.rules.1.max_vias_per_net@4bb5d604199d)
- `net_topology.AUDIO_MCLK.max_vias_per_net` = 0 vias [policy] (from manifest.json#net_topology.rules.2.max_vias_per_net@4bb5d604199d)
...
Limits applied:
- `source_authority` = native_kicad policy [policy] (from manifest.json#source_authority.authority@4bb5d604199d)
...
Limits applied:
- `routing.permitted_turn_degrees` = [0.0, 45.0] deg [policy] (from manifest.json#routing.permitted_turn_degrees@4bb5d604199d)
- `routing.angle_tolerance_deg` = 1.0 deg [policy] (from manifest.json#routing.angle_tolerance_deg@4bb5d604199d)
...
Limits applied:
- `routing.min_segment_mm` = 0.25 mm [policy] (from manifest.json#routing.min_segment_mm@4bb5d604199d)
...
Limits applied:
- `stackup.expected` = [{'role': 'signal'}, {'role': 'plane', 'plane_net': 'GND'}, {'role': 'plane', 'plane_net': '+3V3A'}, {'role': 'signal'}] layer roles [policy] (from manifest.json#stackup.expected@4bb5d604199d)
...
Limits applied:
- `geometry.contact_mm` = 1e-06 mm [tolerance] (from manifest.json#geometry_profile.tolerances.contact_mm.value@4bb5d604199d)
- `geometry.polygon_chord_error_mm` = 0.001 mm [tolerance] (from manifest.json#geometry_profile.tolerances.polygon_chord_error_mm.value@4bb5d604199d)
...
Limits applied:
- `via_mask.populated_pad_attributes` = ['SMD'] pad attribute [policy] (from manifest.json#via_mask.pad_contact.populated_pad_attributes@4bb5d604199d)
- `via_mask.mask_dam_rule` = contact policy [policy] (from manifest.json#via_mask.mask_dam_rule@4bb5d604199d)
...
Limits applied:
- `process_limit_mm` = 0.35 mm [policy] (from manifest.json#via_mask.process.limit_mm@4bb5d604199d)
- `geometry.polygon_chord_error_mm` = 0.001 mm [tolerance] (from manifest.json#geometry_profile.tolerances.polygon_chord_error_mm.value@4bb5d604199d)
- `via_mask.metric` = annulus_to_opening_mm field name [policy] (from manifest.json#via_mask.metric@4bb5d604199d)
...
Limits applied:
- `design_target_mm` = 0.4 mm [policy] (from manifest.json#via_mask.design_target_mm@4bb5d604199d)
- `geometry.polygon_chord_error_mm` = 0.001 mm [tolerance] (from manifest.json#geometry_profile.tolerances.polygon_chord_error_mm.value@4bb5d604199d)
- `via_mask.metric` = annulus_to_opening_mm field name [policy] (from manifest.json#via_mask.metric@4bb5d604199d)
